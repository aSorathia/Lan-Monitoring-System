 ...
 * @author ABDULLAH
 */
public class ProcessViewerMain {
    ...
    private void mainWindow() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("ProcessViewer.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
        primaryStage.setTitle("Process Viewer");
        primaryStage.setScene(scene);
        ProcessViewerController controller = loader.getController();
        controller.setList(client, clientName);
        primaryStage.show();
    }
}
