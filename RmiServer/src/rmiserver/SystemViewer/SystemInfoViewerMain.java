 ...
 * @author ABDULLAH
 */
public class SystemInfoViewerMain {
    ...
    private void mainWindow() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SystemInfoViewer.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
        primaryStage.setTitle("Process Viewer");
        primaryStage.setScene(scene);
        SystemInfoViewerController controller = loader.getController();
        controller.setSystemInfoObject(client, clientName);
        primaryStage.show();
    }
}
